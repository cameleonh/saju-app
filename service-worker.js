const CACHE = 'saju-app-shell-v10';
const ASSETS = ['./', './index.html', './annual/client.mjs', './annual/storage.mjs', './chart/natal-engine.mjs', './chart/natal-ephemeris-data.mjs', './manifest.webmanifest', './icon.svg'];
